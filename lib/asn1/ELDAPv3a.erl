...
%% Purpose: encoder and decoder to the types in mod ELDAPv3a

-module('ELDAPv3a').
-compile(nowarn_unused_vars).
-dialyzer(no_improper_lists).
-include("ELDAPv3a.hrl").
-asn1_info([{vsn,'4.0.2'},
            {module,'ELDAPv3a'},
            {options,[{i,"lib/asn1"},ber,noobj,{outdir,"lib/asn1"},{i,"."},{i,"asn1"}]}]).
...
%%-------------------------------------------------
%% attribute controls(3)   External ELDAPv3a:Controls OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute referral(4)   External ELDAPv3a:Referral OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute authentication(3)   External ELDAPv3a:AuthenticationChoice
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute filter(7)   External ELDAPv3a:Filter
%%-------------------------------------------------
   {EncBytes7,EncLen7} = 'enc_Filter'(Cindex7, []),

%%-------------------------------------------------
%% attribute attributes(8)   External ELDAPv3a:AttributeSelection
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute attributes(2)   External ELDAPv3a:PartialAttributeList
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute modification(2)   External ELDAPv3a:PartialAttribute
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute attributes(2)   External ELDAPv3a:AttributeList
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute ava(2)   External ELDAPv3a:AttributeValueAssertion
%%-------------------------------------------------
